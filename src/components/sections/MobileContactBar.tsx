...
export default function MobileContactBar() {
  ...
  return (
    <div className="lg:hidden bg-surface-secondary border-t border-border px-6 py-8 flex flex-col gap-3">
      <p className="text-ink-muted leading-relaxed">{t.contact.subtitle}</p>
      <p className="text-xs font-semibold uppercase tracking-wider text-ink-muted mt-1 mb-1">
        {t.contact.or_reach}
      </p>
      {socialLinks.map((s) => (
        <a
