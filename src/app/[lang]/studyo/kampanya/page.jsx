...
// app/studyo/kampanya/page.jsx
// Kampanya Stüdyosu — Google Ads kampanya kurulumunu AI ile destekleyen wizard
// Aşama 1: Hedef seçimi · Aşama 2: Kampanya türü seçimi
// (Sonraki 6 aşama yakında eklenecek)
...
import Stepper from '@/components/studyo/kampanya/Stepper'
import SektorInput from '@/components/studyo/kampanya/SektorInput'
import OptionCard from '@/components/studyo/kampanya/OptionCard'
...
export default function KampanyaStudyosuPage() {
  ...
  // ── Auth gate (mevcut studyo ile aynı sessionStorage flag'ini kullanır)
  ...
  // ── Aşama 2: tür analizi (hedef seçildiğinde otomatik)
  ...
  // ── Tür seç + 3. aşamaya geç (placeholder)
    ...
    <div style={{ maxWidth: 980, margin: '0 auto', padding: '2rem 1rem', fontFamily: 'inherit' }}>
      ...
      {aktifAdim === 1 && (
        <section>
          ...
          {hedefHata && (
            <div style={hataKutusu}>{hedefHata}</div>
          )}
          ...
          <div style={altBar}>
            ...
            <button
              onClick={hedefSecVeIlerle}
              disabled={!secilenHedef}
              style={primaryBtn(!secilenHedef)}
            >
              Devam →
            </button>
          </div>
      ...
      {aktifAdim === 2 && (
        <section>
          ...
          <div style={altBar}>
            ...
            <button
              onClick={turSecVeIlerle}
              disabled={!secilenTur}
              style={primaryBtn(!secilenTur)}
            >
              Devam →
            </button>
          </div>
